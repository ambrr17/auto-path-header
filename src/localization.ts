...
export const messages = {
  en: {
    ...
    errorCopyingWithHeader: 'Error copying with path header: {0}',
    commentAlreadyExists: 'Comment already exists in file',
    extensionDisabled: 'Extension {0} is disabled in settings',
    nothingInClipboard: 'Nothing in clipboard to copy with path header',
    getCopied: '✓ Path + content copied to clipboard',
    ...
    pathCommentsUpdatedCount: 'Path comments updated: {0} files',
  ...
  ru: {
    ...
    errorCopyingWithHeader: 'Ошибка копирования с комментарием пути: {0}',
    commentAlreadyExists: 'Комментарий уже существует в файле',
    extensionDisabled: 'Расширение {0} отключено в настройках',
    nothingInClipboard: 'Нет данных в буфере обмена для копирования с комментарием пути',
    getCopied: '✓ Путь + контент скопированы в буфер',
    ...
    pathCommentsUpdatedCount: 'Комментарии с путями обновлены: {0} файлов',
